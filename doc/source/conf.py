...
latex_documents = [
  ('index', 'EmacsIPythonNotebook.tex', u'Emacs IPython Notebook Documentation',
   u'Takafumi Arakaki, John Miller', 'manual'),
]
...
man_pages = [
    ('index', 'emacsipythonnotebook', u'Emacs IPython Notebook Documentation',
     [u'Takafumi Arakaki & John Miller'], 1)
]
...
texinfo_documents = [
  ('index', 'EmacsIPythonNotebook', u'Emacs IPython Notebook Documentation',
   u'Takafumi Arakaki & John Miller', 'EmacsIPythonNotebook', 'One line description of project.',
   'Miscellaneous'),
]
