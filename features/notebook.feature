...
Scenario: kernel reconnect succeeds
  ...
  And header says "Kernel requires reconnect \[ein:notebook-reconnect-session-command]"
  And I clear log expr "ein:log-all-buffer-name"
  And I press "C-c C-r"
  And I wait for the smoke to clear
  And header does not say "Kernel requires reconnect \[ein:notebook-reconnect-session-command]"
  And I switch to log expr "ein:log-all-buffer-name"
